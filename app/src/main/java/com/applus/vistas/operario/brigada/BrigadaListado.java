...
public class BrigadaListado extends AppCompatActivity {
	...
	ArrayList<BrigadaParcelable> servicios;
	
	BrigadaController ServCont=new BrigadaController();
	Activity Activity;
	Intent intentar;
	Context context;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
									long id) {
				try {
					BrigadaParcelable o = (BrigadaParcelable) parent.getItemAtPosition(position);
					vistaDetalle(o);
					/*Toast.makeText(
					this,
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.menu_brigada_main, menu);
		return true;
	}
	@Override
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.mnuevabrigada:
			intentar = new Intent(this, BrigadaActivity.class);
	...
	public void actualizarVistas(){
		try{
			lista.setAdapter(new BrigadasAdaptadorLista(Activity, servicios));
	...
	/*protected class LoadNextPage extends AsyncTask<BrigadaParcelable, Void, BrigadaParcelable> {
		...
		@Override
		protected BrigadaParcelable doInBackground(BrigadaParcelable... params) {
			servicios=ServCont.consultar(offset,PAGESIZE,"",Activity);
			return null;
		}
		
		protected void onPostExecute(BrigadaParcelable parm) {
			try{
				setListAdapter(new BrigadasAdaptadorLista(Activity, servicios));
	...
	public void vistaDetalle(BrigadaParcelable servicio){
